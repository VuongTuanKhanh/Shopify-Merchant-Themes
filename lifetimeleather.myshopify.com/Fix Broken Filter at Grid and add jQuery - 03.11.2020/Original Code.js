...
function usfViews(col) {
    $('.usf-views .usf-active').removeClass('usf-active')
    $(`.usf-flex-view-${col}`).addClass('usf-active');
    if (col != 1) {
        usfCol = col;
        var cl = 'col-lg-' + usfCol + ' col-md-' + usfCol + ' col-' + usfCol + ' mt__30 pr_grid_item product  desgin__1 usf-grid-item'
        $('.usf-grid-item').attr('class', cl)
    }
}
...
<div :class="'col-lg-' + usfCol + ' col-md-' + usfCol + ' col-' + usfCol + ' mt__30 pr_grid_item product nt_pr desgin__1 usf-grid-item'" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave">
    <div class="product-inner pr">
        <div class="product-image pr oh lazyload" :data-include="productUrl + '/?view=img' + window.usf_sectionSettings.sett_equal">
       ...
       <div class="product-info mt__15">
        ...
        <usf-plugin name="searchResultsProductLabel" :data="pluginData"></usf-plugin>
          ...
          <!--price-->
            ...
            <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid lazyload" :data-include="productUrl + '/?view=sw' + window.usf_sectionSettings.sett_equal"></div>
       </div>
    </div>
 </div>
`,
