// Fixed Duplicated Product Image
// Lasted Update: 19:22 p.m - 10/09/2020
// Original Version at: https://github.com/VuongTuanKhanh/Shopify-Merchant-Themes/tree/main/justicejewelers.myshopify.com/Fix%20Duplicate%20Image%20-%2009.10.2020
...
<div class="product-wrap">
    <div class="relative product_image" :class="{'swap-true':(usf.settings.search.showAltImage),'swap-false':!usf.settings.search.showAltImage}">
        <a :href="productUrl" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" style="display:block;position: relative;">
            ...
            <div class="image__container" v-if="_usf_collection_secondary_image && (usf.settings.search.showAltImage) && (_usf_quick_shop_enabled && _usf_quick_shop_style == 'inline')">
                <img :alt="product.title"
