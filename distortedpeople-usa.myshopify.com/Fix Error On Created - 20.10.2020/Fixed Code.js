...
<div class="usf-sr-container" :class="{'usf-no-facets': noFacets, 'usf-empty': !loader && !hasResults, 'usf-nosearch': !showSearchBox}">
    ...
    <div class="collection-filter" v-else-if="window.USF_CollectionSidebar && (window.USF_CollectionSidebar['filter_style'] == 'drawer' && !usf.settings.filters.horz && !usf.isMobile)">
        `+ configTemplatePC + `
    </div>
    <div class="usf-sr-config" v-else-if="window.USF_CollectionSidebar && (window.USF_CollectionSidebar['filter_style'] != 'drawer' && !usf.settings.filters.horz && !usf.isMobile)">
...
usf.event.add('init', function () {
    ...
    var blockFilterV1 = {
        ...
        mounted() {
            var isDrawer ;
            if (window.USF_CollectionSidebar) {
                isDrawer = window.USF_CollectionSidebar['filter_style'] == 'drawer';
            }
